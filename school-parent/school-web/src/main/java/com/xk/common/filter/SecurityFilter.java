...
public class SecurityFilter implements Filter {
                ...
                for (int i = 0; i < cookies.length; i++) {
                    ...
                    if (cookie.getName().equals(Const.LOGIN_SESSION_KEY)) {
                        ...
                        if (userRepository == null) {
                            ...
                            userRepository = (UserService) factory.getBean("userServiceImpl");
                        }
    ...
    {
        if (url.endsWith(".txt") || url.endsWith(".js") || url.endsWith(".css") || url.endsWith(".jpg") || url.endsWith(".gif") || url.endsWith(".png") || url.endsWith(".html") || url.endsWith(".eot") || url.endsWith(".svg") || url.endsWith(".ttf") || url.endsWith(".woff") || url.endsWith(".ico") || url.endsWith(".woff2") || url.endsWith(".otf")) {
            return true;
        } else {
            return false;
        }
