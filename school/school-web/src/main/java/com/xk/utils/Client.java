...
public class Client {
	...
	public static void main(String[] args) throws UnsupportedEncodingException{
		...
		//短信发送	
        String   content   =   java.net.URLEncoder.encode("接口测试【祥付宝】",  "utf-8");  
		String result_mt = client.mdsmssend("15210211432", content,  "", "", "", "");	
		
		//String result_mt = client.register("北京", "北京市", "服务业", "祥付宝", "孙学辉", "010-60609522", "13811570227", "sunxuehui@fullrich.com", "60609522", "海淀区中关村软件园8号楼华夏科技大厦202、204", "100193");
