...
public class LoggerAdvice
{
    ...
    @Before("within(com.xk..*) && @annotation(loggerManage)")
    ...
    @AfterReturning("within(com.xk..*) && @annotation(loggerManage)")
    public void addAfterReturningLogger(JoinPoint joinPoint, LoggerManage loggerManage)
    {
        logger.info("执行 " + loggerManage.description() + " 结束");
    }

    @AfterThrowing(pointcut = "within(com.xk..*) && @annotation(loggerManage)", throwing = "ex")
